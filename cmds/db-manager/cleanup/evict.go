...
var (
	...
	checkSurvTSAs = flags.Bool("surveillance_tsa", false, "set this flag to true to check for expired surveillance TSAs")
	checkSurvSubs = flags.Bool("surveillance_sub", false, "set this flag to true to check for expired surveillance subscriptions")
	survTtl       = flags.Duration("surveillance_ttl", time.Hour*24*112, "time-to-live duration used for determining surveillance entries expiration, defaults to 2*56 days")
