-- This migration is equivalent to surveillance v1.0.0 schema for CockroachDB with the notable exception
...
CREATE INDEX tsa_owner_idx ON identification_service_areas (owner);
CREATE INDEX tsa_starts_at_idx ON identification_service_areas (starts_at);
CREATE INDEX tsa_ends_at_idx ON identification_service_areas (ends_at);
CREATE INDEX tsa_updated_at_idx ON identification_service_areas (updated_at);
